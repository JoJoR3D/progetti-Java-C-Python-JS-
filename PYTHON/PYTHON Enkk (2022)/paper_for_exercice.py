...
def name_page_web(months, years):
    page_name= []
...
page_name= name_page_web(months, years)



# Ottenere il testo completo di una pagina Wikipedia

data= get_page(page_name)
...
database= json.dumps(data, indent= 3)      #indent è un parametro di json.dumps()
print(database)
