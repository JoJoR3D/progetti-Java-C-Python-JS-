...
table = PrettyTable() #assegno alla variabile table la classe PrettyTable()
table.field_names= ["Campo_1", "Campo_2"]   #nome delle due colonne
...
table.add_row(["Il numero di parole inserite è:", count_world]) #aggiungo righe alla tabella

print(f"Il numero di segni di interpunzione sono: {count_symbolize}")
table.add_row(["Il numero di segni di interpunzione sono:", count_symbolize])

#print(f"Il numero di frasi sono: {count_symbolize}")
table.add_row(["Il numero di frasi sono:", count_symbolize])
...
table.add_row(["Il carattere più frequente è:", carattere_piu_frequente])

#print(f"\nIl carattere meno frequente è: {carattere_meno_frequente}")
table.add_row(["Il carattere meno frequente è:", carattere_meno_frequente])

print(table)    #stampiamo la tabella